  ...
  return (
    <TableContainer 
      ...
      sx={{ 
        ...
        overflow: 'hidden',
        width: '100%' // Asegura que el contenedor use el 100%
      }}
    >
      <Table sx={{ width: '100%', tableLayout: 'fixed' }}> {/* Se quitó el minWidth de 1000 */}
        <TableHead sx={{ bgcolor: '#0f172a' }}>
          <TableRow>
            <TableCell sx={{ color: '#f8fafc', fontWeight: 700, py: 3, width: '30%' }}>PRODUCTO / CÓDIGO</TableCell>
            <TableCell sx={{ color: '#f8fafc', fontWeight: 700, width: '22%' }}>ESPECIFICACIONES</TableCell>
            <TableCell sx={{ color: '#f8fafc', fontWeight: 700, width: '20%' }}>ATRIBUTOS</TableCell>
            <TableCell sx={{ color: '#f8fafc', fontWeight: 700, width: '15%' }}>ESTADO</TableCell>
            <TableCell align="right" sx={{ color: '#f8fafc', fontWeight: 700, pr: 4, width: '13%' }}>GESTIÓN</TableCell>
          </TableRow>
        </TableHead>
            ...
            >
              <TableCell>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                  <Avatar 
                    variant="rounded" 
                    sx={{ 
                      width: 48, // Ajuste ligero de tamaño para ganar espacio
                      height: 48, 
                  ...
                  <Box sx={{ minWidth: 0 }}> {/* Permite que el texto se trunque si es necesario */}
                    ...
                    <Typography noWrap sx={{ fontWeight: 800, color: '#1e293b', fontSize: '0.9rem', lineHeight: 1.2 }}>
                      {p.nombre_producto}
                    </Typography>
              ...
              <TableCell>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    ...
                    <Typography variant="body2" noWrap sx={{ fontWeight: 600, color: '#475569' }}>
                      {p.tipo_producto}
                    </Typography>
                  </Box>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    <LayersTwoTone sx={{ fontSize: 16, color: '#8b5cf6' }} />
                    <Typography variant="caption" noWrap sx={{ color: '#64748b', fontWeight: 500 }}>
                      {p.nombre_material}
                    </Typography>
                  </Box>
                </Box>
              ...
              <TableCell>
                <Chip
                  ...
                  icon={p.activo ? <CheckCircleTwoTone sx={{ fontSize: '14px !important' }} /> : <CancelTwoTone sx={{ fontSize: '14px !important' }} />}
                  sx={{
                    fontWeight: 900,
                    fontSize: '0.6rem',
                    letterSpacing: '0.5px',
